<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container">
        ...
        <a href="/" class="navbar-brand navbar-brand-autodark">
            <h3 class="font-weight-bold">STOK UMUM</h3>
        </a>
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('backoffice.transaction*') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-title">
                            {{ Auth::user()->hasRole('admin') ? 'Barang Keluar' : 'Transaksi' }}
                        </span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                @role('admin')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('backoffice.bagian*') ? 'active' : '' }}"
                            href="{{ route('backoffice.bagian.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
